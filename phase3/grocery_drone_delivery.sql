...
Create table CHAIN_ITEM( 
	...
	FOREIGN KEY (ChainItemName)
		REFERENCES ITEM(ItemName)
		on delete cascade on update cascade,
	FOREIGN KEY (ChainName)
		REFERENCES CHAIN(ChainName)
		on delete cascade on update cascade, -- if chain not available, no item in chain
...
Create table ADMIN( 
	...
	FOREIGN KEY (Username)
        ...
        on delete restrict on update restrict, -- not sure, cannot change admin? 
	PRIMARY KEY (Username) 
); 
...
CREATE TABLE DRONE_TECH (
    ...
    FOREIGN KEY (Username)
        ...
        ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (StoreName , ChainName)
        REFERENCES STORE (StoreName , ChainName)
        ON DELETE CASCADE ON UPDATE CASCADE,
    PRIMARY KEY (Username)
); 
...
CREATE TABLE DRONE (
    ...
    FOREIGN KEY (DroneTech)
        REFERENCES DRONE_TECH (Username)
        ON DELETE CASCADE ON UPDATE CASCADE,
    PRIMARY KEY (ID)
); 
...
Create table ORDERS( 
	...
	FOREIGN KEY (CustomerUsername)
        ...
        on delete cascade on update cascade, -- if customer gone, set null for now???
	FOREIGN KEY (DroneID)
		REFERENCES DRONE(ID)
        on delete cascade on update cascade, -- if drone is gone, set null for now. 
	PRIMARY KEY (ID) 
); 
...
CREATE TABLE CONTAINS (
    ...
    FOREIGN KEY (OrderID)
        ...
        ON DELETE CASCADE ON UPDATE CASCADE, -- maybe restrict?
    FOREIGN KEY (ItemName , ChainName , PLUNumber)
        REFERENCES CHAIN_ITEM (ChainItemName , ChainName , PLUNumber)
        ON DELETE CASCADE ON UPDATE CASCADE,
